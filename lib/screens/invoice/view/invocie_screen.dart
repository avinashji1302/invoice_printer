...
class CreateInvoiceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final grandTotal = provider.invoicesItems.fold<double>(0, (sum, item) {
              ...
              children: [
                ...
                _card(
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomTextField(
                        validator: provider.cutomerNmae.text,
                        hint: "Customer Name",
                    ...
                    children: [
                      ...
                      provider.invoicesItems.isEmpty
                          ...
                          : ListView.separated(
                              ...
                              itemBuilder: (_, index) {
                                final item = provider.invoicesItems[index];
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      final validate = provider.checkValidation();
